...
class OfferGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Offer entity")
        ...
        .repeat(2) {
            ...
            .post("/api/offers")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "priceUSD":null, "discountPercent":null, "createdAt":"2020-01-01T00:00:00.000Z", "limitAt":"2020-01-01T00:00:00.000Z", "grade":null, "timeType":null, "offerType":null, "description":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
